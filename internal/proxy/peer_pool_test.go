...
func TestPeerPoolReusesConnectionAndGrowsLazily(t *testing.T) {
	...
	s1, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	s2, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	...
	_ = s1.Close()
	_ = s2.Close()
	s3, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	if got := dials.Load(); got != 2 {
...
func TestPeerPoolRetainsBackoffAfterIdleDialFailure(t *testing.T) {
	...
	if _, err := p.OpenStream(context.Background(), "unbounded-host", PeerEndpoint{Address: "addr", Generation: 1}); err == nil {
...
func TestPeerPoolEndpointReplacementUsesNewEndpoint(t *testing.T) {
	...
	s, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	_ = s.Close()
	s, err = p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 2})
	if err != nil {
		t.Fatal(err)
	}
	_ = s.Close()
...
func TestPeerPoolReplacementDuringDialDiscardsStaleConnection(t *testing.T) {
	...
	pp := p.(*peerPool)
	pp.mu.Lock()
	pp.hosts["host"].replaceLocked("new", 2)
	pp.mu.Unlock()
	close(oldRelease)
	second, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 2})
	if err != nil {
		t.Fatal(err)
	}
	_ = second.Close()
...
func TestPeerPoolStreamFailureRemovesConnection(t *testing.T) {
	...
	s2, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	_ = s2.Close()
...
func TestPeerPoolDrainForceClosesActiveStream(t *testing.T) {
	...
	if _, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1}); err != nil {
		t.Fatal(err)
	}
	started := time.Now()
	_ = p.Close()
...
func TestPeerStreamOpenCallerCancellationKeepsConnectionUsable(t *testing.T) {
	...
	cancel()
	if _, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1}); !errors.Is(err, context.Canceled) {
...
func TestPeerStreamOpenFailureClosesTransport(t *testing.T) {
	...
	defer cancel()
	_, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err == nil {
...
func TestPeerPoolOpaqueStreamsAreIsolatedAndPreserveEOFAndCancellation(t *testing.T) {
	...
	a, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	b, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	...
	ctx, cancel := context.WithCancel(context.Background())
	cancel()
	if _, err := p.OpenStream(ctx, "other", PeerEndpoint{Address: "addr", Generation: 1}); !errors.Is(err, context.Canceled) {
...
func TestPeerPoolFailureTerminatesActiveStreamsWithoutReplayAndRecovers(t *testing.T) {
	...
	ctx, cancel := context.WithTimeout(context.Background(), 2*time.Second)
	defer cancel()
	s3, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	if dials.Load() < 2 {
...
func TestPeerPoolFailedDialBackoffAppliesToNextCaller(t *testing.T) {
	...
	defer p.Close()
	_, _ = p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	ctx, cancel := context.WithTimeout(context.Background(), 10*time.Millisecond)
	defer cancel()
	if _, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1}); !errors.Is(err, context.DeadlineExceeded) {
...
func TestPeerPoolShutdownUsesOneDeadline(t *testing.T) {
	...
	for _, host := range []string{"a", "b", "c", "d"} {
		if _, err := p.OpenStream(context.Background(), host, PeerEndpoint{Address: "old", Generation: 1}); err != nil {
			t.Fatal(err)
		}
		if _, err := p.OpenStream(context.Background(), host, PeerEndpoint{Address: "new", Generation: 2}); err != nil {
			t.Fatal(err)
		}
	}
	start := time.Now()
...
func TestPeerPoolReplacementRemainsRegistered(t *testing.T) {
	...
	defer p.Close()
	stream, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	_ = stream.Close()
	...
	original.mu.Unlock()
	for i := 0; i < 10; i++ {
		stream, err = p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 2})
		if err != nil {
			t.Fatal(err)
		}
		_ = stream.Close()
	...
	for _, operation := range []string{"replace", "close"} {
		t.Run(operation, func(t *testing.T) {
			...
			if operation == "replace" {
				...
				defer cancel()
				s, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "new", Generation: 2})
				if err != nil {
					t.Fatal(err)
				}
				_ = s.Close()
...
func TestPeerPoolWriteEOFReleasesCapacity(t *testing.T) {
	...
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()
	next, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	_ = next.Close()
...
func TestPeerPoolHandshakeOutcome(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			s, _ := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
			if s != nil {
				_ = s.Close()
			}
			_ = p.Close()
	...
	for _, operation := range []string{"shutdown", "replacement"} {
		for _, published := range []int32{0, 1} {
			t.Run(fmt.Sprintf("%s/published=%d", operation, published), func(t *testing.T) {
				...
				if published > 0 {
					var err error
					old, err = p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
					if err != nil {
						t.Fatal(err)
					}
				}
				...
				go func() {
					s, _ := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
					done <- s
				}()
				<-client.started
				...
				if operation == "shutdown" {
					...
					var err error
					replacement, err = p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 2})
					if err != nil {
						t.Fatal(err)
					}
					want = 1
...
func waitPeerWaiter(t *testing.T, h *hostPool) {
	...
	for time.Now().Before(deadline) {
		h.mu.Lock()
		waiting := h.changed != nil || h.waiters.Len() > 0
		h.mu.Unlock()
		if waiting {
			return
		}
	...
	for _, state := range []string{"backoff", "saturated"} {
		for _, operation := range []string{"close", "replace", "cancel", "release"} {
			...
			t.Run(state+"/"+operation, func(t *testing.T) {
				...
				defer p.Close()
				first, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
				if err != nil {
					t.Fatal(err)
				}
				defer first.Close()
				...
				go func() {
					s, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "old", Generation: 1})
					if s != nil {
						_ = s.Close()
					}
					done <- err
...
func TestPeerPoolCountsRetiredConnectionsUntilDrainCompletes(t *testing.T) {
	...
	_ = old.Close()
	waitPeerCondition(t, func() bool { return metrics.total.Load() == 1 })
	waitPeerConnectionTelemetry(t, old)
	...
	for _, operation := range []string{"shutdown", "replacement", "failure"} {
		t.Run(operation, func(t *testing.T) {
			...
			case "shutdown":
				_ = p.Close()
			case "replacement":
				next, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 2})
				if err != nil {
					t.Fatal(err)
				}
				_ = next.Close()
...
func TestPeerPoolCancelsRetiredPendingStreamOpens(t *testing.T) {
	for _, operation := range []string{"replacement", "shutdown"} {
		t.Run(operation, func(t *testing.T) {
			...
			defer p.Close()
			established, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 1})
			if err != nil {
				t.Fatal(err)
			}
...
func TestPeerPoolBlockedPublicationTelemetryDoesNotBlockShutdown(t *testing.T) {
	...
	for i := 0; i < 20; i++ {
		next, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
		if err != nil {
			t.Fatal(err)
		}
		_ = next.Close()
...
func TestPeerPoolDialTelemetryDoesNotBlockOpenOrShutdown(t *testing.T) {
	for _, kind := range []string{"handshake", "connection", "reconnect"} {
		t.Run(kind, func(t *testing.T) {
			...
			if kind == "reconnect" {
				pool := p.(*peerPool)
				pool.hosts["host"] = &hostPool{parent: pool, host: "host", addr: "addr", endpointGeneration: 1, failures: 1}
			}
			opened := make(chan PeerStream, 1)
			go func() {
				s, _ := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
...
func TestPeerPoolWatchesRetirementWithoutFailureSignal(t *testing.T) {
	...
	defer p.Close()
	old, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	defer old.Close()
...
func TestPeerPoolStaleDialCloserDoesNotBlockReplacement(t *testing.T) {
	...
	open := func(addr string, generation uint64) {
		s, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: addr, Generation: generation})
		if s != nil {
			_ = s.Close()
		}
		done <- err
...
func TestPeerPoolFailedOpenRetiresBeforeSlowClose(t *testing.T) {
	...
	go func() {
		s, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
		if s != nil {
			_ = s.Close()
		}
		opened <- err
...
func TestPeerPoolReconnectObservationsExcludeOrdinaryDials(t *testing.T) {
	...
	first, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	defer first.Close()
	second, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	defer second.Close()
	cold, err := p.OpenStream(context.Background(), "other", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	defer cold.Close()
	...
	waitPeerCondition(t, func() bool {
		other.parent.observations.mu.Lock()
		defer other.parent.observations.mu.Unlock()
		return !other.parent.observations.emitting
	})
	h := first.(*countedPeerStream).host
	waitPeerCondition(t, func() bool {
		h.parent.observations.mu.Lock()
		defer h.parent.observations.mu.Unlock()
		return !h.parent.observations.emitting
	})
	recorder.mu.Lock()
	defer recorder.mu.Unlock()
	var results []string
...
func TestPeerPoolEndpointChurnRetainsConnectionBudget(t *testing.T) {
	var live, peak atomic.Int32
	p := NewPeerTransport(PeerPoolConfig{MaxConnections: 1, DrainTimeout: time.Hour, Dial: func(context.Context, string, string) (PeerClient, io.Closer, error) {
		n := live.Add(1)
		if n > peak.Load() {
			peak.Store(n)
		}
		return &testPeerClient{}, callbackPeerCloser{close: func() { live.Add(-1) }}, nil
	}})
	first, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "first", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	second, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "second", Generation: 2})
	if err != nil {
		t.Fatal(err)
	}
	for i := 0; i < 20; i++ {
		ctx, cancel := context.WithTimeout(context.Background(), time.Millisecond)
		_, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: fmt.Sprint(i), Generation: uint64(i + 3)})
		cancel()
		if !errors.Is(err, context.DeadlineExceeded) {
			t.Fatalf("churn open=%v", err)
		}
	}
	if peak.Load() != 2 || live.Load() != 2 {
		t.Fatalf("connections live=%d peak=%d", live.Load(), peak.Load())
	}
	_ = first.Close()
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()
	next, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "latest", Generation: 23})
	if err != nil {
		t.Fatal(err)
	}
	if peak.Load() > 2 {
		t.Fatal("replacement exceeded physical connection budget")
	}
	_ = second.Close()
	_ = next.Close()
	_ = p.Close()
...
type stalledConnectionTelemetry struct {
	noopPeerTelemetry
	calls, total atomic.Int32
	entered      chan struct{}
	release      chan struct{}
}

func (m *stalledConnectionTelemetry) PeerConnection(delta int) {
	if m.calls.Add(1) == 1 {
		close(m.entered)
	}
	<-m.release
	m.total.Add(int32(delta))
}
func TestPeerPoolBoundsTelemetryAcrossReconnects(t *testing.T) {
	metrics := &stalledConnectionTelemetry{entered: make(chan struct{}), release: make(chan struct{})}
	var once sync.Once
	defer once.Do(func() { close(metrics.release) })
	p := NewPeerTransport(PeerPoolConfig{Telemetry: metrics, Dial: func(context.Context, string, string) (PeerClient, io.Closer, error) {
		return &testPeerClient{}, &countingCloser{}, nil
	...
	for i := 0; i < 20; i++ {
		...
		cs.host.markFailed(cs.conn)
		cs.host.mu.Lock()
		cs.host.retryAt = time.Time{}
		cs.host.mu.Unlock()
	}
	_ = p.Close()
	if metrics.calls.Load() != 1 {
		t.Fatalf("blocked emitters=%d", metrics.calls.Load())
	}
	once.Do(func() { close(metrics.release) })
	waitPeerCondition(t, func() bool {
		p.connectionMetrics.mu.Lock()
		defer p.connectionMetrics.mu.Unlock()
		return !p.connectionMetrics.emitting
	})
	if metrics.total.Load() != 0 {
		t.Fatalf("unbalanced connections=%d", metrics.total.Load())
	}
}

func TestPeerPoolClosedDialReturnsBeforeSlowCleanup(t *testing.T) {
	started, closing, release := make(chan struct{}), make(chan struct{}), make(chan struct{})
	var once sync.Once
	defer once.Do(func() { close(release) })
	p := NewPeerTransport(PeerPoolConfig{DrainTimeout: 10 * time.Millisecond, Dial: func(ctx context.Context, _, _ string) (PeerClient, io.Closer, error) {
		close(started)
		<-ctx.Done()
		return &testPeerClient{}, callbackPeerCloser{close: func() { close(closing); <-release }}, nil
	}})
	...
	go func() {
		_, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
		done <- err
	}()
	<-started
	_ = p.Close()
	...
	case <-closing:
	case <-time.After(time.Second):
		t.Fatal("discarded dial cleanup did not start")
	}
	select {
	case err := <-done:
		if err == nil {
			t.Fatal("open succeeded during shutdown")
		}
	case <-time.After(time.Second):
		t.Fatal("closed dial blocked requester on cleanup")
	}
}

func TestPeerPoolEvictsIdleHostsPreservingActiveStreams(t *testing.T) {
	dial, _, conns := testDialer()
	...
	waitPeerCondition(t, func() bool { p.mu.Lock(); defer p.mu.Unlock(); return len(p.hosts) == 1 })
	for _, c := range (*conns)[1:] {
		if c.closed.Load() != 1 {
			t.Fatal("idle transport remained open")
		}
	}
...
func TestPeerPoolReusedConnectionCancelsIdleEviction(t *testing.T) {
	dial, dials, conns := testDialer()
	p := NewPeerTransport(PeerPoolConfig{Dial: dial, IdleTimeout: 20 * time.Millisecond})
	first, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
	if err != nil {
		t.Fatal(err)
	}
	...
	if dials.Load() != 1 || (*conns)[0].closed.Load() != 0 {
		t.Fatal("reuse failed to retain active connection")
	}
	_ = next.Close()
	waitPeerCondition(t, func() bool { return (*conns)[0].closed.Load() == 1 })
	_ = p.Close()
}
func TestPeerPoolFinalStreamCloseDoesNotWaitForTransport(t *testing.T) {
	closing, release := make(chan struct{}), make(chan struct{})
	var once sync.Once
	defer once.Do(func() { close(release) })
	p := NewPeerTransport(PeerPoolConfig{Dial: func(_ context.Context, _, addr string) (PeerClient, io.Closer, error) {
	...
	case <-done:
	case <-time.After(time.Second):
		t.Fatal("stream close waited for transport closer")
	}
	once.Do(func() { close(release) })
	_ = next.Close()
	_ = p.Close()
...
func TestPeerPoolIgnoresDelayedEndpointGeneration(t *testing.T) {
	dial, dials, _ := testDialer()
	p := NewPeerTransport(PeerPoolConfig{Dial: dial})
	old, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 10})
	if err != nil {
		t.Fatal(err)
	}
	defer old.Close()
	current, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 20})
	if err != nil {
		t.Fatal(err)
	}
	defer current.Close()
	late, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "old", Generation: 10})
	if err != nil {
		t.Fatal(err)
	}
	if late.(*countedPeerStream).conn != current.(*countedPeerStream).conn || dials.Load() != 2 {
		t.Fatal("delayed endpoint replaced the current connection")
	}
	_ = late.Close()
	if _, err := current.Write([]byte("still active")); err != nil {
		t.Fatal(err)
	}
	if _, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "other", Generation: 20}); err == nil {
		t.Fatal("accepted conflicting address with unchanged generation")
	}
	if _, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new"}); err == nil {
		t.Fatal("accepted unversioned endpoint")
	}
	// A restarted peer can reuse its address but must get a fresh connection.
	restarted, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "new", Generation: 21})
	if err != nil {
		t.Fatal(err)
	}
	if restarted.(*countedPeerStream).conn == current.(*countedPeerStream).conn {
		t.Fatal("reused previous incarnation")
	}
	_ = old.Close()
	_ = current.Close()
	_ = restarted.Close()
...
func TestPeerPoolCapacityNotificationWakesOneWaiter(t *testing.T) {
	h := &hostPool{}
	const count = 128
	ready := make([]chan struct{}, count)
	for i := range ready {
		ready[i] = make(chan struct{})
		h.waiters.PushBack(ready[i])
	}
	for i := range ready {
		h.notifyLocked()
		for j, ch := range ready {
			select {
			case <-ch:
				if j > i {
					t.Fatalf("notification %d woke waiter %d", i, j)
				}
			default:
				if j <= i {
					t.Fatalf("notification %d skipped waiter %d", i, j)
				}
			}
		}
	}
...
func TestPeerPoolCapacityQueueProgress(t *testing.T) {
	dial, _, _ := testDialer()
	p := NewPeerTransport(PeerPoolConfig{Dial: dial, MaxConnections: 1, StreamsPerConnection: 1}).(*peerPool)
	endpoint := PeerEndpoint{Address: "addr", Generation: 1}
	first, err := p.OpenStream(context.Background(), "host", endpoint)
	if err != nil {
		t.Fatal(err)
	}
	h := p.hosts["host"]
	...
	for i := 0; i < count; i++ {
		go func() {
			s, err := p.OpenStream(ctx, "host", endpoint)
			if s != nil {
				_ = s.Close()
			}
			done <- err
	...
	waitPeerCondition(t, func() bool { h.mu.Lock(); defer h.mu.Unlock(); return h.waiters.Len() == count })
	_ = first.Close()
	for i := 0; i < count; i++ {
		if err := <-done; err != nil {
			t.Fatal(err)
...
func TestPeerPoolCanceledCapacitySelectionPassesNotification(t *testing.T) {
	h := &hostPool{}
	ctx, cancel := context.WithCancel(context.Background())
	done := make(chan error, 1)
	go func() { h.mu.Lock(); done <- h.waitCapacityLocked(ctx) }()
	waitPeerCondition(t, func() bool { h.mu.Lock(); defer h.mu.Unlock(); return h.waiters.Len() == 1 })
	h.mu.Lock()
	next := make(chan struct{})
	h.waiters.PushBack(next)
	h.wakeOneLocked()
	cancel()
	h.mu.Unlock()
	...
	case <-next:
	default:
		t.Fatal("canceled selection stranded next waiter")
	}
}

func TestPeerPoolRetainsEndpointAfterEviction(t *testing.T) {
	for _, failed := range []bool{false, true} {
		t.Run(fmt.Sprint("failed=", failed), func(t *testing.T) {
			var dials atomic.Int32
			p := NewPeerTransport(PeerPoolConfig{Dial: func(_ context.Context, _, addr string) (PeerClient, io.Closer, error) {
				if addr != "latest" {
					t.Errorf("dialed obsolete endpoint %q", addr)
				}
				if dials.Add(1) == 1 && failed {
					return nil, nil, errors.New("unavailable")
				}
				return &testPeerClient{}, &countingCloser{}, nil
			}}).(*peerPool)
			defer p.Close()
			stream, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "latest", Generation: 20})
			if (err != nil) != failed {
			...
			h.mu.Unlock()
			h.evictIdle(generation)
			waitPeerCondition(t, func() bool { p.mu.Lock(); defer p.mu.Unlock(); return p.hosts["host"] == nil })
			p.mu.Lock()
			latest := p.endpoints["host"]
			p.mu.Unlock()
			if latest.Generation != 20 || latest.Address != "latest" {
				t.Fatalf("retained endpoint = %+v", latest)
			}
			if _, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "conflict", Generation: 20}); err == nil {
				t.Fatal("accepted conflicting address after eviction")
			}
			late, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "obsolete", Generation: 10})
			if err != nil {
				t.Fatal(err)
			}
			_ = late.Close()
...
type completedIOPeer struct {
	singleClosePeerStream
	result error
}

func (s *completedIOPeer) Read([]byte) (int, error)  { return 1, s.result }
func (s *completedIOPeer) Write([]byte) (int, error) { return 1, s.result }

type completionPeerClient struct {
	first PeerStream
	calls atomic.Int32
}

func (c *completionPeerClient) OpenPeerStream(context.Context) (PeerStream, error) {
	if c.calls.Add(1) == 1 {
		return c.first, nil
	}
	return &testPeerStream{}, nil
...
func TestPeerPoolCompletionReturnsBeforeStreamCleanup(t *testing.T) {
	for _, result := range []error{io.EOF, status.Error(codes.PermissionDenied, "rejected")} {
		for _, op := range []string{"read", "write"} {
			t.Run(op+"/"+result.Error(), func(t *testing.T) {
				raw := &completedIOPeer{singleClosePeerStream: singleClosePeerStream{started: make(chan struct{}), release: make(chan struct{}), err: errors.New("close result")}, result: result}
				var release sync.Once
				defer release.Do(func() { close(raw.release) })
				client := &completionPeerClient{first: raw}
				closer := &countingCloser{}
				metrics := &drainStreamTelemetry{drained: make(chan struct{}, 8)}
				p := NewPeerTransport(PeerPoolConfig{Telemetry: metrics, MaxConnections: 1, StreamsPerConnection: 1, Dial: func(context.Context, string, string) (PeerClient, io.Closer, error) { return client, closer, nil }})
				s, err := p.OpenStream(context.Background(), "host", PeerEndpoint{Address: "addr", Generation: 1})
				if err != nil {
					t.Fatal(err)
				}
				...
				case <-done:
				case <-time.After(time.Second):
					t.Fatal("I/O result blocked on stream cleanup")
				}
				select {
				case <-raw.started:
				case <-time.After(time.Second):
					t.Fatal("stream cleanup did not start")
				}
				waitPeerStreamTelemetry(t, s)
				if metrics.total.Load() != 0 {
					t.Fatal("completed stream still counted while its closer is blocked")
				}
				ctx, cancel := context.WithTimeout(context.Background(), time.Second)
				defer cancel()
				sibling, err := p.OpenStream(ctx, "host", PeerEndpoint{Address: "addr", Generation: 1})
				if err != nil {
					t.Fatal(err)
				}
				if _, err := sibling.Write([]byte("healthy")); err != nil {
					t.Fatal(err)
				}
				if sibling.(*countedPeerStream).conn != s.(*countedPeerStream).conn || closer.closed.Load() != 0 {
					t.Fatal("completion retired the shared connection")
				}
				release.Do(func() { close(raw.release) })
				if err := s.Close(); err != raw.err {
					t.Fatalf("close result = %v", err)
				}
				if raw.calls.Load() != 1 {
					t.Fatalf("physical closes = %d", raw.calls.Load())
				}
				waitPeerStreamTelemetry(t, sibling)
				if metrics.total.Load() != 1 {
					t.Fatal("late physical close changed replacement stream accounting")
				}
				_ = sibling.Close()
				waitPeerStreamTelemetry(t, sibling)
				if metrics.total.Load() != 0 || metrics.negative.Load() {
					t.Fatal("stream accounting did not balance")
				}
				_ = p.Close()
			})
		}
