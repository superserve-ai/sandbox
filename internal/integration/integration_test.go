...
func (s *stubVMD) RestoreSnapshot(_ context.Context, _, _, _, _, _, _, _ string, _ string, _ map[int32]int64, _ int64, _ map[string]string) (string, uint32, uint32, error) {
	return "10.0.0.1", 1, 1024, nil
}
...
func (s *stubVMD) UpdateSandboxPreviewPolicy(_ context.Context, _, _ string, _ map[int32]int64, _ int64) error {
	return nil
}
