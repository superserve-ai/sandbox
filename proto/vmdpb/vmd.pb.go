...
const file_proto_vmd_proto_rawDesc = "" +
	...
	"\x0fVM_STATUS_ERROR\x10\x052\xda\f\n" +
	"\bVMDaemon\x12V\n" +
	...
	"\x14DeleteBuildArtifacts\x12..superserve.vmd.v1.DeleteBuildArtifactsRequest\x1a/.superserve.vmd.v1.DeleteBuildArtifactsResponse\x12^\n" +
...
var file_proto_vmd_proto_goTypes = []any{
	...
	(*ExecCommandRequest)(nil),              // 32: superserve.vmd.v1.ExecCommandRequest
	(*ExecCommandResponse)(nil),             // 33: superserve.vmd.v1.ExecCommandResponse
	(*GetVMInfoRequest)(nil),                // 34: superserve.vmd.v1.GetVMInfoRequest
	(*GetVMInfoResponse)(nil),               // 35: superserve.vmd.v1.GetVMInfoResponse
	(*SetupNetworkRequest)(nil),             // 36: superserve.vmd.v1.SetupNetworkRequest
	(*SetupNetworkResponse)(nil),            // 37: superserve.vmd.v1.SetupNetworkResponse
	(*UpdateSandboxNetworkRequest)(nil),     // 38: superserve.vmd.v1.UpdateSandboxNetworkRequest
	(*UpdateSandboxNetworkResponse)(nil),    // 39: superserve.vmd.v1.UpdateSandboxNetworkResponse
...
var file_proto_vmd_proto_depIdxs = []int32{
	...
	40, // 5: superserve.vmd.v1.ResumeVMRequest.env_vars:type_name -> superserve.vmd.v1.ResumeVMRequest.EnvVarsEntry
	...
	41, // 9: superserve.vmd.v1.RestoreSnapshotRequest.env_vars:type_name -> superserve.vmd.v1.RestoreSnapshotRequest.EnvVarsEntry
	12, // 10: superserve.vmd.v1.RestoreSnapshotResponse.resource_limits:type_name -> superserve.vmd.v1.ResourceLimits
	42, // 11: superserve.vmd.v1.ExecCommandRequest.env:type_name -> superserve.vmd.v1.ExecCommandRequest.EnvEntry
	...
	32, // 25: superserve.vmd.v1.VMDaemon.ExecCommand:input_type -> superserve.vmd.v1.ExecCommandRequest
	34, // 26: superserve.vmd.v1.VMDaemon.GetVMInfo:input_type -> superserve.vmd.v1.GetVMInfoRequest
	36, // 27: superserve.vmd.v1.VMDaemon.SetupNetwork:input_type -> superserve.vmd.v1.SetupNetworkRequest
	38, // 28: superserve.vmd.v1.VMDaemon.UpdateSandboxNetwork:input_type -> superserve.vmd.v1.UpdateSandboxNetworkRequest
	...
	33, // 41: superserve.vmd.v1.VMDaemon.ExecCommand:output_type -> superserve.vmd.v1.ExecCommandResponse
	35, // 42: superserve.vmd.v1.VMDaemon.GetVMInfo:output_type -> superserve.vmd.v1.GetVMInfoResponse
	37, // 43: superserve.vmd.v1.VMDaemon.SetupNetwork:output_type -> superserve.vmd.v1.SetupNetworkResponse
	39, // 44: superserve.vmd.v1.VMDaemon.UpdateSandboxNetwork:output_type -> superserve.vmd.v1.UpdateSandboxNetworkResponse
