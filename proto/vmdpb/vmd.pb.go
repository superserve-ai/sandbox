...
const file_proto_vmd_proto_rawDesc = "" +
	...
	" \x01(\tR\x0emanifestDigest\"\x86\x03\n" +
	...
	"\x18expected_manifest_digest\x18\b \x01(\tR\x16expectedManifestDigest\"\xd1\x01\n" +
	...
	"\x14exclusive_size_bytes\x18\x02 \x01(\x03R\x12exclusiveSizeBytes\"\x9c\x04\n" +
	...
	"\x0fVM_STATUS_ERROR\x10\x052\xd0\x15\n" +
	"\bVMDaemon\x12h\n" +
...
var file_proto_vmd_proto_goTypes = []any{
	...
	(*RestoreSnapshotResponse)(nil),         // 34: superserve.vmd.v1.RestoreSnapshotResponse
	(*InjectSandboxEnvRequest)(nil),         // 35: superserve.vmd.v1.InjectSandboxEnvRequest
	(*InjectSandboxEnvResponse)(nil),        // 36: superserve.vmd.v1.InjectSandboxEnvResponse
	(*DeleteSnapshotRequest)(nil),           // 37: superserve.vmd.v1.DeleteSnapshotRequest
	(*DeleteSnapshotResponse)(nil),          // 38: superserve.vmd.v1.DeleteSnapshotResponse
	(*DeleteSandboxSnapshotsRequest)(nil),   // 39: superserve.vmd.v1.DeleteSandboxSnapshotsRequest
	(*DeleteSandboxSnapshotsResponse)(nil),  // 40: superserve.vmd.v1.DeleteSandboxSnapshotsResponse
	(*DeleteTemplateArtifactsRequest)(nil),  // 41: superserve.vmd.v1.DeleteTemplateArtifactsRequest
	(*DeleteTemplateArtifactsResponse)(nil), // 42: superserve.vmd.v1.DeleteTemplateArtifactsResponse
	(*DeleteBuildArtifactsRequest)(nil),     // 43: superserve.vmd.v1.DeleteBuildArtifactsRequest
	(*DeleteBuildArtifactsResponse)(nil),    // 44: superserve.vmd.v1.DeleteBuildArtifactsResponse
	(*ListBuildArtifactsRequest)(nil),       // 45: superserve.vmd.v1.ListBuildArtifactsRequest
	(*BuildArtifactEntry)(nil),              // 46: superserve.vmd.v1.BuildArtifactEntry
	(*ListBuildArtifactsResponse)(nil),      // 47: superserve.vmd.v1.ListBuildArtifactsResponse
	(*ListDirRequest)(nil),                  // 48: superserve.vmd.v1.ListDirRequest
	(*ListDirResponse)(nil),                 // 49: superserve.vmd.v1.ListDirResponse
	(*ListDirEntry)(nil),                    // 50: superserve.vmd.v1.ListDirEntry
	(*GetVMInfoRequest)(nil),                // 51: superserve.vmd.v1.GetVMInfoRequest
	(*GetVMInfoResponse)(nil),               // 52: superserve.vmd.v1.GetVMInfoResponse
	(*SetupNetworkRequest)(nil),             // 53: superserve.vmd.v1.SetupNetworkRequest
	(*SetupNetworkResponse)(nil),            // 54: superserve.vmd.v1.SetupNetworkResponse
	(*UpdateSandboxNetworkRequest)(nil),     // 55: superserve.vmd.v1.UpdateSandboxNetworkRequest
	(*UpdateSandboxNetworkResponse)(nil),    // 56: superserve.vmd.v1.UpdateSandboxNetworkResponse
	(*InvalidateSecretRequest)(nil),         // 57: superserve.vmd.v1.InvalidateSecretRequest
	(*InvalidateSecretResponse)(nil),        // 58: superserve.vmd.v1.InvalidateSecretResponse
	(*RevokeSandboxRequest)(nil),            // 59: superserve.vmd.v1.RevokeSandboxRequest
	(*RevokeSandboxResponse)(nil),           // 60: superserve.vmd.v1.RevokeSandboxResponse
	(*InvalidateSandboxRulesRequest)(nil),   // 61: superserve.vmd.v1.InvalidateSandboxRulesRequest
	(*InvalidateSandboxRulesResponse)(nil),  // 62: superserve.vmd.v1.InvalidateSandboxRulesResponse
	nil,                                     // 63: superserve.vmd.v1.ResumeVMRequest.EnvVarsEntry
	nil,                                     // 64: superserve.vmd.v1.RestoreSnapshotRequest.EnvVarsEntry
	nil,                                     // 65: superserve.vmd.v1.InjectSandboxEnvRequest.EnvVarsEntry
	nil,                                     // 66: superserve.vmd.v1.GetVMInfoResponse.MetadataEntry
}
var file_proto_vmd_proto_depIdxs = []int32{
	...
	63, // 5: superserve.vmd.v1.ResumeVMRequest.env_vars:type_name -> superserve.vmd.v1.ResumeVMRequest.EnvVarsEntry
	...
	14, // 11: superserve.vmd.v1.RestoreSavedSnapshotResponse.resource_limits:type_name -> superserve.vmd.v1.ResourceLimits
	14, // 12: superserve.vmd.v1.RestoreSnapshotRequest.resource_limits:type_name -> superserve.vmd.v1.ResourceLimits
	15, // 13: superserve.vmd.v1.RestoreSnapshotRequest.network_config:type_name -> superserve.vmd.v1.NetworkConfig
	64, // 14: superserve.vmd.v1.RestoreSnapshotRequest.env_vars:type_name -> superserve.vmd.v1.RestoreSnapshotRequest.EnvVarsEntry
	14, // 15: superserve.vmd.v1.RestoreSnapshotResponse.resource_limits:type_name -> superserve.vmd.v1.ResourceLimits
	65, // 16: superserve.vmd.v1.InjectSandboxEnvRequest.env_vars:type_name -> superserve.vmd.v1.InjectSandboxEnvRequest.EnvVarsEntry
	46, // 17: superserve.vmd.v1.ListBuildArtifactsResponse.entries:type_name -> superserve.vmd.v1.BuildArtifactEntry
	50, // 18: superserve.vmd.v1.ListDirResponse.entries:type_name -> superserve.vmd.v1.ListDirEntry
	0,  // 19: superserve.vmd.v1.GetVMInfoResponse.status:type_name -> superserve.vmd.v1.VMStatus
	14, // 20: superserve.vmd.v1.GetVMInfoResponse.resource_limits:type_name -> superserve.vmd.v1.ResourceLimits
	66, // 21: superserve.vmd.v1.GetVMInfoResponse.metadata:type_name -> superserve.vmd.v1.GetVMInfoResponse.MetadataEntry
	15, // 22: superserve.vmd.v1.SetupNetworkRequest.network_config:type_name -> superserve.vmd.v1.NetworkConfig
	17, // 23: superserve.vmd.v1.UpdateSandboxNetworkRequest.egress:type_name -> superserve.vmd.v1.SandboxNetworkEgressConfig
	1,  // 24: superserve.vmd.v1.VMDaemon.GetCapabilities:input_type -> superserve.vmd.v1.GetCapabilitiesRequest
	18, // 25: superserve.vmd.v1.VMDaemon.DestroyVM:input_type -> superserve.vmd.v1.DestroyVMRequest
	20, // 26: superserve.vmd.v1.VMDaemon.PauseVM:input_type -> superserve.vmd.v1.PauseVMRequest
	22, // 27: superserve.vmd.v1.VMDaemon.ResumeVM:input_type -> superserve.vmd.v1.ResumeVMRequest
	24, // 28: superserve.vmd.v1.VMDaemon.CreateSnapshot:input_type -> superserve.vmd.v1.CreateSnapshotRequest
	27, // 29: superserve.vmd.v1.VMDaemon.RestoreSavedSnapshot:input_type -> superserve.vmd.v1.RestoreSavedSnapshotRequest
	29, // 30: superserve.vmd.v1.VMDaemon.DeleteSavedSnapshot:input_type -> superserve.vmd.v1.DeleteSavedSnapshotRequest
	31, // 31: superserve.vmd.v1.VMDaemon.GetWritableLayerUsage:input_type -> superserve.vmd.v1.GetWritableLayerUsageRequest
	33, // 32: superserve.vmd.v1.VMDaemon.RestoreSnapshot:input_type -> superserve.vmd.v1.RestoreSnapshotRequest
	35, // 33: superserve.vmd.v1.VMDaemon.InjectSandboxEnv:input_type -> superserve.vmd.v1.InjectSandboxEnvRequest
	37, // 34: superserve.vmd.v1.VMDaemon.DeleteSnapshot:input_type -> superserve.vmd.v1.DeleteSnapshotRequest
	39, // 35: superserve.vmd.v1.VMDaemon.DeleteSandboxSnapshots:input_type -> superserve.vmd.v1.DeleteSandboxSnapshotsRequest
	41, // 36: superserve.vmd.v1.VMDaemon.DeleteTemplateArtifacts:input_type -> superserve.vmd.v1.DeleteTemplateArtifactsRequest
	43, // 37: superserve.vmd.v1.VMDaemon.DeleteBuildArtifacts:input_type -> superserve.vmd.v1.DeleteBuildArtifactsRequest
	45, // 38: superserve.vmd.v1.VMDaemon.ListBuildArtifacts:input_type -> superserve.vmd.v1.ListBuildArtifactsRequest
	48, // 39: superserve.vmd.v1.VMDaemon.ListDir:input_type -> superserve.vmd.v1.ListDirRequest
	51, // 40: superserve.vmd.v1.VMDaemon.GetVMInfo:input_type -> superserve.vmd.v1.GetVMInfoRequest
	53, // 41: superserve.vmd.v1.VMDaemon.SetupNetwork:input_type -> superserve.vmd.v1.SetupNetworkRequest
	55, // 42: superserve.vmd.v1.VMDaemon.UpdateSandboxNetwork:input_type -> superserve.vmd.v1.UpdateSandboxNetworkRequest
	57, // 43: superserve.vmd.v1.VMDaemon.InvalidateSecret:input_type -> superserve.vmd.v1.InvalidateSecretRequest
	59, // 44: superserve.vmd.v1.VMDaemon.RevokeSandbox:input_type -> superserve.vmd.v1.RevokeSandboxRequest
	61, // 45: superserve.vmd.v1.VMDaemon.InvalidateSandboxRules:input_type -> superserve.vmd.v1.InvalidateSandboxRulesRequest
	3,  // 46: superserve.vmd.v1.VMDaemon.BuildTemplate:input_type -> superserve.vmd.v1.BuildTemplateRequest
	8,  // 47: superserve.vmd.v1.VMDaemon.GetBuildStatus:input_type -> superserve.vmd.v1.GetBuildStatusRequest
	10, // 48: superserve.vmd.v1.VMDaemon.CancelBuild:input_type -> superserve.vmd.v1.CancelBuildRequest
	12, // 49: superserve.vmd.v1.VMDaemon.StreamBuildLogs:input_type -> superserve.vmd.v1.StreamBuildLogsRequest
	2,  // 50: superserve.vmd.v1.VMDaemon.GetCapabilities:output_type -> superserve.vmd.v1.GetCapabilitiesResponse
	19, // 51: superserve.vmd.v1.VMDaemon.DestroyVM:output_type -> superserve.vmd.v1.DestroyVMResponse
	21, // 52: superserve.vmd.v1.VMDaemon.PauseVM:output_type -> superserve.vmd.v1.PauseVMResponse
	23, // 53: superserve.vmd.v1.VMDaemon.ResumeVM:output_type -> superserve.vmd.v1.ResumeVMResponse
	25, // 54: superserve.vmd.v1.VMDaemon.CreateSnapshot:output_type -> superserve.vmd.v1.CreateSnapshotResponse
	28, // 55: superserve.vmd.v1.VMDaemon.RestoreSavedSnapshot:output_type -> superserve.vmd.v1.RestoreSavedSnapshotResponse
	30, // 56: superserve.vmd.v1.VMDaemon.DeleteSavedSnapshot:output_type -> superserve.vmd.v1.DeleteSavedSnapshotResponse
	32, // 57: superserve.vmd.v1.VMDaemon.GetWritableLayerUsage:output_type -> superserve.vmd.v1.GetWritableLayerUsageResponse
	34, // 58: superserve.vmd.v1.VMDaemon.RestoreSnapshot:output_type -> superserve.vmd.v1.RestoreSnapshotResponse
	36, // 59: superserve.vmd.v1.VMDaemon.InjectSandboxEnv:output_type -> superserve.vmd.v1.InjectSandboxEnvResponse
	38, // 60: superserve.vmd.v1.VMDaemon.DeleteSnapshot:output_type -> superserve.vmd.v1.DeleteSnapshotResponse
	40, // 61: superserve.vmd.v1.VMDaemon.DeleteSandboxSnapshots:output_type -> superserve.vmd.v1.DeleteSandboxSnapshotsResponse
	42, // 62: superserve.vmd.v1.VMDaemon.DeleteTemplateArtifacts:output_type -> superserve.vmd.v1.DeleteTemplateArtifactsResponse
	44, // 63: superserve.vmd.v1.VMDaemon.DeleteBuildArtifacts:output_type -> superserve.vmd.v1.DeleteBuildArtifactsResponse
	47, // 64: superserve.vmd.v1.VMDaemon.ListBuildArtifacts:output_type -> superserve.vmd.v1.ListBuildArtifactsResponse
	49, // 65: superserve.vmd.v1.VMDaemon.ListDir:output_type -> superserve.vmd.v1.ListDirResponse
	52, // 66: superserve.vmd.v1.VMDaemon.GetVMInfo:output_type -> superserve.vmd.v1.GetVMInfoResponse
	54, // 67: superserve.vmd.v1.VMDaemon.SetupNetwork:output_type -> superserve.vmd.v1.SetupNetworkResponse
	56, // 68: superserve.vmd.v1.VMDaemon.UpdateSandboxNetwork:output_type -> superserve.vmd.v1.UpdateSandboxNetworkResponse
	58, // 69: superserve.vmd.v1.VMDaemon.InvalidateSecret:output_type -> superserve.vmd.v1.InvalidateSecretResponse
	60, // 70: superserve.vmd.v1.VMDaemon.RevokeSandbox:output_type -> superserve.vmd.v1.RevokeSandboxResponse
	62, // 71: superserve.vmd.v1.VMDaemon.InvalidateSandboxRules:output_type -> superserve.vmd.v1.InvalidateSandboxRulesResponse
	7,  // 72: superserve.vmd.v1.VMDaemon.BuildTemplate:output_type -> superserve.vmd.v1.BuildTemplateResponse
	9,  // 73: superserve.vmd.v1.VMDaemon.GetBuildStatus:output_type -> superserve.vmd.v1.GetBuildStatusResponse
	11, // 74: superserve.vmd.v1.VMDaemon.CancelBuild:output_type -> superserve.vmd.v1.CancelBuildResponse
	13, // 75: superserve.vmd.v1.VMDaemon.StreamBuildLogs:output_type -> superserve.vmd.v1.BuildLogEvent
