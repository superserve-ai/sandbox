...
const (
	...
	VMDaemon_CreateSavedSnapshot_FullMethodName        = "/superserve.vmd.v1.VMDaemon/CreateSavedSnapshot"
	...
	VMDaemon_ReviveVM_FullMethodName                   = "/superserve.vmd.v1.VMDaemon/ReviveVM"
...
type VMDaemonClient interface {
	...
	// may resume.
	DeleteSandboxSnapshots(ctx context.Context, in *DeleteSandboxSnapshotsRequest, opts ...grpc.CallOption) (*DeleteSandboxSnapshotsResponse, error)
	...
	// running source.
	CreateSavedSnapshot(ctx context.Context, in *CreateSavedSnapshotRequest, opts ...grpc.CallOption) (*CreateSavedSnapshotResponse, error)
	...
	ReviveVM(ctx context.Context, in *ReviveVMRequest, opts ...grpc.CallOption) (*ReviveVMResponse, error)
...
func (c *vMDaemonClient) DeleteSandboxSnapshots(ctx context.Context, in *DeleteSandboxSnapshotsRequest, opts ...grpc.CallOption) (*DeleteSandboxSnapshotsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteSandboxSnapshotsResponse)
	err := c.cc.Invoke(ctx, VMDaemon_DeleteSandboxSnapshots_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMDaemonClient) CreateSavedSnapshot(ctx context.Context, in *CreateSavedSnapshotRequest, opts ...grpc.CallOption) (*CreateSavedSnapshotResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSavedSnapshotResponse)
	err := c.cc.Invoke(ctx, VMDaemon_CreateSavedSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMDaemonClient) ReviveVM(ctx context.Context, in *ReviveVMRequest, opts ...grpc.CallOption) (*ReviveVMResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReviveVMResponse)
	err := c.cc.Invoke(ctx, VMDaemon_ReviveVM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VMDaemonServer interface {
	...
	// delete was missed. Only for a sandbox being deleted — never for one that
	// may resume.
	DeleteSandboxSnapshots(context.Context, *DeleteSandboxSnapshotsRequest) (*DeleteSandboxSnapshotsResponse, error)
	// Saved snapshots: customer captures a new sandbox can be created from.
	// Idempotent on snapshot_id; the caller syncs the guest before capturing a
	// running source.
	CreateSavedSnapshot(context.Context, *CreateSavedSnapshotRequest) (*CreateSavedSnapshotResponse, error)
	...
	// carries the sandbox's identity, so nothing is re-injected, and any
	// residue of the dead VM is force-torn-down first.
	ReviveVM(context.Context, *ReviveVMRequest) (*ReviveVMResponse, error)
	// UpdateSandboxNetwork atomically replaces the egress allow/deny rules for a running VM.
...
func (UnimplementedVMDaemonServer) DeleteSandboxSnapshots(context.Context, *DeleteSandboxSnapshotsRequest) (*DeleteSandboxSnapshotsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteSandboxSnapshots not implemented")
}
func (UnimplementedVMDaemonServer) CreateSavedSnapshot(context.Context, *CreateSavedSnapshotRequest) (*CreateSavedSnapshotResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSavedSnapshot not implemented")
}
...
func (UnimplementedVMDaemonServer) ReviveVM(context.Context, *ReviveVMRequest) (*ReviveVMResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReviveVM not implemented")
}
...
func _VMDaemon_DeleteSandboxSnapshots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteSandboxSnapshotsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VMDaemonServer).DeleteSandboxSnapshots(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VMDaemon_DeleteSandboxSnapshots_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMDaemonServer).DeleteSandboxSnapshots(ctx, req.(*DeleteSandboxSnapshotsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _VMDaemon_CreateSavedSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSavedSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VMDaemonServer).CreateSavedSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VMDaemon_CreateSavedSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMDaemonServer).CreateSavedSnapshot(ctx, req.(*CreateSavedSnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VMDaemon_ReviveVM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReviveVMRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VMDaemonServer).ReviveVM(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VMDaemon_ReviveVM_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMDaemonServer).ReviveVM(ctx, req.(*ReviveVMRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VMDaemon_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteSandboxSnapshots",
			Handler:    _VMDaemon_DeleteSandboxSnapshots_Handler,
		},
		{
			MethodName: "CreateSavedSnapshot",
			Handler:    _VMDaemon_CreateSavedSnapshot_Handler,
		},
		{
		...
		{
			MethodName: "ReviveVM",
			Handler:    _VMDaemon_ReviveVM_Handler,
		},
		{
