...
type VMDaemonClient interface {
	...
	// instance record (any state — the record, not the VM, is what the edge
	// proxy reads). Used by the control plane for live public/private toggles
	// and preview-token rotation; restores carry the policy on
	// RestoreSnapshotRequest instead.
