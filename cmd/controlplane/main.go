...
func run() error {
	...
	dbReadiness := api.NewProductionDBReadiness(dbPool, recorder, nil)
	// The production readiness monitor is owned by the control-plane lifecycle;
	// SetupRouter only starts readiness instances it creates itself.
