...
func runBuild(ctx context.Context, cfg buildConfig) error {
	...
	// flatten=true: per-sandbox restores skip apply_delta. Safe here — base isn't shared yet.
	if err := vm.CreateSnapshot(socketPath, snapPath, memPath, snapDir, true); err != nil {
