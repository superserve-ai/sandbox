...
contract in `supabase/migrations/20260917194153_sandbox_proxy_router.sql` in each
...
The migration preserves existing credentials. For a new role, set a generated
